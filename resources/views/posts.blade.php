...
@section('content')
    ...
    <button  type="button" class="btn btn-basic "><a style ="color: #969696; font-size: larger; font-weight: 700" href="{{route('app.posts.create')}}">{{'Your posts'}}</a></button>

    <div class="titleList" style="font-size: 27px; font-weight: 700; text-align: center; margin-bottom: 10px"> All Posts </div>
